...
obj_to_del = [obj for obj in objs if obj.type != 'CAMERA' and obj.type != 'EMPTY' and obj.name != 'Ground']
for obj in obj_to_del:
    # objs.remove(obj, do_unlink=True)
    makeInvisible(obj)
ground_obj = objs['Ground']
...
for i in range(0, VIEWS):
    ...
    frame_data = {
        ...
        'transform_ground': listify_matrix(ground_obj.matrix_world),
    }
